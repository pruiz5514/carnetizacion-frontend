...
import { IPostEstablishments, IPostEstablishmentsForm } from '../../../App/Core/application/dto/establishment/post-establishment.dto'
...
const EstablishmentForm:React.FC<IEstablishmentFormProps> = ({closeModal}) => {
    ...
    const handleLogin = async (data:IPostEstablishmentsForm) => {
        try{
            const establishment = {
                ...data,
                "role_id": 2
